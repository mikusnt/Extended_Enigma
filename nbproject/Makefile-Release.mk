...
${OBJECTDIR}/INIReader.o: INIReader.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/INIReader.o INIReader.cpp

${OBJECTDIR}/enigma.o: enigma.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/enigma.o enigma.cpp
...
${TESTDIR}/tests/rotate_tests.o: tests/rotate_tests.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/rotate_tests.o tests/rotate_tests.cpp
...
${OBJECTDIR}/INIReader_nomain.o: ${OBJECTDIR}/INIReader.o INIReader.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/INIReader_nomain.o INIReader.cpp;\
	else  \
...
${OBJECTDIR}/enigma_nomain.o: ${OBJECTDIR}/enigma.o enigma.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/enigma_nomain.o enigma.cpp;\
	else  \
...
${OBJECTDIR}/ini_nomain.o: ${OBJECTDIR}/ini.o ini.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ini_nomain.o ini.c;\
	else  \
